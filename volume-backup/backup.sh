...
zip "$TMP_DIR/$ARCHIVE_NAME" "$TMP_DIR/gravity.db" "$TMP_DIR/pihole-FTL.db" "$TMP_DIR/budget.db" "$TMP_DIR/tradebot.db"
...
rm "$TMP_DIR/$ARCHIVE_NAME" "$TMP_DIR/gravity.db" "$TMP_DIR/pihole-FTL.db" "$TMP_DIR/budget.db" "$TMP_DIR/tradebot.db"
